  ...
  estimate is at least +40 with the lower bound above +25, else 2.3.3.
    ...
    - **A.3.3 Time-forfeit repair — `R2` investigation, `I1` fix, `V`
      ...
      **Disposition 2026-09-09: diagnosed and repaired, `LOCAL_QUALIFIED`;
      RAR-R11 decides.** The seven forfeits are one population of 50–500 ms
      ...
      every engine. Evidence: `analysis/time_forfeit_2026-09-09.md`.
...
|---|---|---|---|
| A.3.3 | LOCAL_QUALIFIED | R2 | Clock now starts at `go` parse as in both donors (`79d3974`); RAR-R11 run is the maintainer's |
