...
void on_hybrid_eval(const Option& o) { HybridEval::set_enabled(double(o) != 0); }
...
void init(OptionsMap& o) {
  ...
  // A neutral default is required for the evaluator-isolation experiment:
  // Rarog's HCE does not consume Stockfish's thread-local contempt score.
  ...
  o["Use Rarog HCE"]         << Option(true, on_hybrid_eval);
